// node_modules/.pnpm/solid-js@1.5.1/node_modules/solid-js/dist/dev.js
var taskIdCounter = 1;
...
function createResource(pSource, pFetcher, pOptions) {
  ...
  let err = void 0, pr = null, initP = NO_INIT, id = null, loadedUnderTransition = false, scheduled = false, resolved = "initialValue" in options, dynamic = typeof source === "function" && createMemo(source);
  const contexts = /* @__PURE__ */ new Set(), [value, setValue] = (options.storage || createSignal)(options.initialValue), [track, trigger] = createSignal(void 0, {
    equals: false
  ...
  function load(refetching = true) {
    ...
    return p.then((v) => loadEnd(p, v, true, lookup2), (e) => loadEnd(p, e, false));
  }
  Object.defineProperties(read, {
    ...
    error: {
      get() {
        return state() === "errored" ? err : void 0;
      }
    },
    latest: {
      get() {
...
//# sourceMappingURL=chunk-BMOKTV46.js.map
